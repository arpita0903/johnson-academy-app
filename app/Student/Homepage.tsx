  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.username}>Hello, <Text style={{ fontWeight: 'bold' }}>Jess</Text></Text>
      </View>
      ...
      <TouchableOpacity style={styles.banner}>
        ...
        <Image source={require('../../assets/images/instruments.png')} style={{ width: 150, height: 120 }} />
      </TouchableOpacity>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.instrumentCard}>
                ...
                <View>
                  <Text style={styles.courseProgress}>Progress: {Math.round(item.progress * 100)}%</Text>
                  <ProgressBar progress={item.progress} color="#8a1dc2" style={styles.progressBar} />
                </View>
              </View>
            )}
          />
